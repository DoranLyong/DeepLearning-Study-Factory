# coding=<utf-8> 
"""
(ref) https://youtu.be/jGst43P-TJA
(ref) https://github.com/aladdinpersson/Machine-Learning-Collection/blob/master/ML/Pytorch/Basics/pytorch_bidirectional_lstm.py
(ref) https://youtu.be/BwmddtPFWtA
(ref) https://www.youtube.com/watch?v=0_PgWWmauHk&t=710s&ab_channel=PythonEngineer
...
"""
Bidirectional LSTM 네트워크를 구성하고 MNIST 데이터셋으로 학습하기 
...
model = BRNN(input_size=28, hidden_size=256, num_layers=2, num_classes=10).to(device)
