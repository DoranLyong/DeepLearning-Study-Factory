...
(ref) https://github.com/aladdinpersson/Machine-Learning-Collection/blob/master/ML/Pytorch/Basics/albumentations_tutorial/classification.py
...
"""
Classification task 를 위한 Image augmentation 튜토리얼 
...
for i in range(15):   # 총 15번 순회하면서 변환 적용하기 

    augmentations = transform(image= img) # 변환 적용 
